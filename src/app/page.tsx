    ...
    <div className="flex flex-col items-center min-h-screen">
      <div className="w-full flex flex-col h-full">
        ...
        <div className="flex-grow overflow-y-auto p-4 space-y-4 h-full">
          ...
          <ChatContainer ref={chatContainerRef} autoScroll={true} className="h-screen text-[15px] fixed top-0 left-0 w-full p-4 pb-52 pt-16">
        ...
        <div className="p-4 fixed bottom-0 w-full overflow-visible">
          <LinearBlur
            ...
            side="bottom"
          />
          <form onSubmit={handleSubmit} className="flex w-full space-x-2 shadow-2xl rounded-3xl relative z-10">
